...
For example, if Environment Name is equal to: 'xxx-graphquery', AZD will create a Azure resources with these names:

| Azure Resource | Name                          | Uniqueness        |
| -------------- | ----------------------------- | ----------------- |
| Resource Group |  rg-xxx-graphquery            | in a subscription |
| Azure Website  |  xxx-graphquery-azd           | global            |
